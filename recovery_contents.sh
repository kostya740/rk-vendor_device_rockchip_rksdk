...
cp -f vendor/rockchip/common/bin/$TARGET_ARCH/sh $PRODUCT_OUT/recovery/root/vendor/bin/
cp -f vendor/rockchip/common/bin/$TARGET_ARCH/busybox $PRODUCT_OUT/recovery/root/vendor/bin/
...
cp -f vendor/rockchip/common/bin/$TARGET_ARCH/parted $PRODUCT_OUT/recovery/root/sbin/
